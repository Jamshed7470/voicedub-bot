...
# версия алгоритма: входит в ключ кэша анализа. Меняется вместе с логикой
# слияния/переприсвоения, иначе старые разборы с десятками ложных спикеров
# подхватятся из кэша и исправление молча не применится.
ALGO_VERSION = 1
